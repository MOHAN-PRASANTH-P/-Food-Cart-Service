...
// import orderSound from "../assets/order-received.mp3"; // 🔊 AUDIO IMPORT
...
//   // 🔊 PLAY AUDIO WHEN ORDER IS CONFIRMED
//   useEffect(() => {
//     if (orderConfirmed) {
...
//     setCart([]);
//     setOrderConfirmed(true); // 🔊 AUDIO TRIGGERS HERE
//   };
...
const API_URL = "https://food-cart-service.onrender.com";
